<template>
    <div class="col-lg-12 mt-4 mb-4 p-4 rounded bg-white shadow" id="news-categories-table">
        <div class="col-lg-12 row border-bottom">
            ...
            <div class="col-lg-6 text-right justify-content-end">
                <a href="/dashboard/news/categories/create" class="btn btn-sm btn-warning mb-3 text-uppercase text-white font-weight-bold">
                    <small>Create</small>
                </a>
            </div>
        </div>
