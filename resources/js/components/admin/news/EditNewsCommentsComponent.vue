<template>
    <div class="col-lg-12 shadow bg-white mt-4 mb-4 p-4 rounded" id="edit-news-comment">
        <form action="/dashboard/news/comments/edit" method="post">
            ...
            <div class="form-group">
                ...
                <div class="text-center p-4 shadow bg-white rounded">
                    ...
                    <a :href="'/news/'+postId" class="robot-font text-muted">
                        {{ this.post }}
                    </a>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            getCurrentComment() {
                ...
                axios.get('/dashboard/news/comments/'+id+'/single-json-comment').then(response => {
                    this.currentComment = response.data;

                    this.comment = this.currentComment['0'].comment;
                    this.author = this.currentComment['0'].user.name;
                    this.post = this.currentComment['0'].news.title;
                    this.postId = this.currentComment['0'].news.id;
                });
            },
            ...
            getFormData() {
                ...
                form.append('_token', document.querySelector(
                    '#dashboard #edit-news-comment input[name="_token"]'
                ).value);
            ...
            editComment() {
                ...
                this.sendRequest('/dashboard/news/comments/'+id+'/edit', data, {
